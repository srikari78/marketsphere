...
<?php
    $result = $conn->query("SELECT * FROM Products where productId = 18");
    $prod = $result -> fetch_assoc();
    $hits = $prod["productHits"] + 1;
    $conn->query("UPDATE Products SET productHits = ".$hits." WHERE productId = 18");    
    //$conn->close();
?>
<?php 
...
<head>
    ...
    <title>Las Vegas | GTS Tours</title>
</head>
<body class="lasVegasPage">
    <?php $page='LasVegas'; include 'navbar.php' ?>
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/1_lasvegas.jpeg" alt="1_lasvegas" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/2_lasvegas.jpeg" alt="2_lasvegas" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/3_lasvegas.jpeg" alt="2_lasvegas" class="d-block" style="width:100%">
            </div>
            </div>
        ...
        <div class="longDescContainer">
            ...
            <p class="longDesc">
            Las Vegas, a dazzling oasis in the Nevada desert, is a city that pulsates with vibrant energy, non-stop entertainment, and a spirit of unabashed extravagance. Known as the "Entertainment Capital of the World," Las Vegas is a glittering playground where towering resorts line the iconic Las Vegas Strip. Each casino-hotel is a testament to opulence, featuring themed architecture, world-class theaters, and an array of attractions that transport visitors to different corners of the globe.
            <br>
            <br>
    ...
    <div class="bottomContainer">
        ...
        <?php 
            $sql = "SELECT * FROM Ratings WHERE productID = 18";
            $result = mysqli_query($conn, $sql);
            $rows = mysqli_num_rows($result);
            if($rows > 0)
            {
