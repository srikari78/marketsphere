        ...
        && !empty($_POST["newPassword"]))
     {
        ...
        else
        {
            ...
            try 
            {
                ...
                //Send to User
                $mail->setFrom('marketsphere272@gmail.com', 'Market Sphere');
                $mail->addAddress($tomail);                                 //Add a recipient
                $mail->addBCC('srikari.veerubhotla@sjsu.edu');
                $mail->addBCC('prashansaevangeline.bonapalle@sjsu.edu');
                $mail->addBCC('sowjanya.bheemineni@sjsu.edu');
                $mail->addBCC('sindhuja.ravi@sjsu.edu');

                

                //Content
                $mail->isHTML(false);                                  //Set email format to HTML
                $mail->Subject = 'Market Sphere | Account Created Successfully';
