    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/scissors3.jpeg" alt="Adhesive Tape1" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/scissors2.jpeg" alt="Adhesive Tape2" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/scissors1.jpeg" alt="Adhesive Tape3" class="d-block" style="width:100%">
            </div>
            </div>
        ...
        <div class="longDescContainer">
            ...
            <p class="longDesc">
                Welcome to the Scissors section of Life Saver Hub, where we offer a variety of high-quality scissors designed for precision and versatility. Our scissors are crafted for sharpness, durability, and user-friendly design.


            <br>
            <br>
           Our scissors are known for their exceptional quality and their ability to provide precise cutting in various applications. Here are a few reasons to consider our scissors for your needs:

            Precision Cutting: Our scissors are designed for precise cutting, making them ideal for various tasks.
            Durable and Long-Lasting: Built to last, our scissors offer reliability and longevity.
            Comfortable Grip: Our scissors provide a comfortable grip, reducing hand fatigue during use.
