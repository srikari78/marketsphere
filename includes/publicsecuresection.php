...
<body class="psecurePage">
    ...
    <div class="loginHomePage">
        ...
        <div class="homebtnsContainer">
            ...
            <a class='loginHomeBtn2 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5LifeSaverHubModal'>Your Top 5 in Life Saver Hub</a>
            <a class='loginHomeBtn3 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5ToursModal'>Your Top 5 in Tours</a>
            <a class='loginHomeBtn3 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5CityVistaRealEstateModal'>Your Top 5 in City Vista Real Estate</a>
            <a class='loginHomeBtn3 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5CarRentalsModal'>Your Top 5 in Car Rentals</a>
    ...
    <div class="modal fade modal-xl" id="top5MarketModal">
     ...
     <!-- The Modal -->
     <div class="modal fade modal-xl" id="top5LifeSaverHubModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in LifeSaverHub Company</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <!-- The Modal -->
    <div class="modal fade modal-xl" id="top5ToursModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in Tours Company</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <!-- The Modal -->
    <div class="modal fade modal-xl" id="top5CityVistaRealEstateModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in City Vista Real Estate Company</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <!-- The Modal -->
     <div class="modal fade modal-xl" id="top5CarRentalsModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in Premium Car Rentals Company</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
