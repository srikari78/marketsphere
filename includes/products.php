...
<head>
    ...
    <title>Products | Browse. Connect. Shop smart</title>
</head>
<body class="productsPage">
    ...
    <div class="sidebar" id="side_nav">
        ...
        <div class="sidebarContent sideNavActive">
            ...
            <ul class="dropdown-menu1 list-unstyled">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisLifeSaverHubModal'>Most Visited in LifeSaverHub</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisToursModal'>Most Visited in Tours</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisCityVistaRealEstateModal'>Most Visited in CityVistaRealEstate</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisCarRentalsModal'>Most Visited in CarRentals</a></li>
                <hr class="mx-3">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevLifeSaverHubModal'>Most Reviewed in LifeSaverHub</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevToursModal'>Most Reviewed in Tours</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevCityVistaRealEstateModal'>Most Reviewed in CityVistaRealEstate</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevCarRentalsModal'>Most Reviewed in CarRentals</a></li>
                <hr class="mx-3">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatLifeSaverHubModal'>Highly Rated in LifeSaverHub</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatToursModal'>Highly Rated in Tours</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatCityVistaRealEstateModal'>Highly Rated in CityVistaRealEstate</a></li>
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatCarRentalsModal'>Highly Rated in CarRentals</a></li>
            </ul>
        </div>
    </div>
    ...
    <footer class="footerContainer">
        ...
        <div class="socialIcons ml-auto">
            <a href="https://www.facebook.com/profile.php?id=61554096215771" target="_blank">
