...
<head>
    ...
    <title>CPR Masks | LifeSaverHub</title>
</head>
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/mask3.jpeg" alt="Adhesive Tape1" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/mask2.jpeg" alt="Adhesive Tape2" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/mask1.jpeg" alt="Adhesive Tape3" class="d-block" style="width:100%">
            </div>
            </div>
        ...
        <div class="longDescContainer">
            ...
            <p class="longDesc">
                Welcome to the Masks section of Life Saver Hub, where we offer a range of high-quality masks designed for various applications. Our masks are crafted for protection, comfort, and versatility.

            <br>
            <br>
            Our masks are known for their exceptional quality and their ability to provide protection in various situations. Here are a few reasons to consider our masks for your needs:

            Effective Protection: Our masks are designed to protect against airborne particles, germs, and pollutants.
            Comfortable Design: Designed for comfort, our masks are suitable for extended use without discomfort.
            Versatile Use: Our masks are suitable for various settings, from healthcare to everyday protection.
